...
<!-- 장르가 판타지인 상품 페이지 -->
	...
	<div id="search_bar">
        ...
        <div id="category">
            <br>
            <ul id="category_nav">
               <li><a href="fantasy.book">판타지전체</a></li>
               <li><a href="fantasyLe.book">정통물</a></li>
               <li><a href="fantasyFu.book">퓨전물</a></li>
               <li><a href="fantasyMo.book">현대물</a></li>
               <li><a href="fantasyCh.book">무협물</a></li>
            </ul>
            <br>
            <hr>
            <br>          
        ...
        <c:if test="${!(list2 eq null)}">
	        <div id="genre_title" style="padding: 20px 0 0 50px">
		    	<h2 style="text-align:center">판타지 인기상품 TOP3</h2>
		    </div>
	        <!-- 인기상품의 순위를 나타내기 위함 -->
		    <% int num=1; %> 
